...
$install_version = Mage::getConfig()->getNode('modules/Orba_Facebook/version');

$msg_title = "Orba Facebook Extension ver. {$install_version} was successfully installed!";
...
//@mail('magento@orba.pl', '[Instalacja] Facebook', "IP: ".$_SERVER['SERVER_ADDR']."\r\nHost: ".gethostbyaddr($_SERVER['SERVER_ADDR']));
